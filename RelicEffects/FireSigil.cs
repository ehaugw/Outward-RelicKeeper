...
namespace RelicKeeper
{
    public static class FireSigil
    {
        ...
        {
            var relicCondition = RelicCondition.Apply(skill, requiredItem, manaCost: 14, durabilityCost: 50, cooldown: 60, castType: Character.SpellCastType.SummonGhost, relicLevel: 1, castModifier: Character.SpellCastModifier.Immobilized, mobileCastMovementMult: 0);
