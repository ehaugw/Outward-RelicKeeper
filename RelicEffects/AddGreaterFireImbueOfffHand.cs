...
namespace RelicKeeper
{
    public static class AddGreaterFireImbueOfffHand
    {
        ...
        {
            var relicCondition = RelicCondition.Apply(skill, requiredItem, manaCost: 14, durabilityCost: 50, cooldown: 200, castType: Character.SpellCastType.Bubble, relicLevel: 1, mobileCastMovementMult: 0, castModifier: Character.SpellCastModifier.Immobilized);
